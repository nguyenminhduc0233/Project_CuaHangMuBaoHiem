            ...
            <ul>
              ...
              ></span>
                    ...
                    >
                        ...
                        <span class="ml-4">Phân cấp người dùng</span>
                    </a>
                </li>
            </ul>
                            ...
                            <tr class="text-gray-700 dark:text-gray-400">
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex items-center space-x-4 text-sm">
                                        <a href="/Project_CuaHangMuBaoHiem_war/change-role?id=<%=cus.getId_customer()%>">
                                           <%if (cus.getPermission()==0){%>
                                            Nâng cấp phân quyền
                                            <%}else if(cus.getPermission()==1){%>
                                            Hạ cấp phân quyền
